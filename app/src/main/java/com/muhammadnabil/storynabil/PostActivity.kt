...
import com.muhammadnabil.storynabil.databinding.ActivityPostBinding
import com.muhammadnabil.storynabil.utils.PreferencesHelper
import com.muhammadnabil.storynabil.utils.reduceFileImage
import com.muhammadnabil.storynabil.utils.rotateFile
import com.muhammadnabil.storynabil.utils.uriToFile
...
class PostActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        ...
        if (getFile != null && !description.isNullOrEmpty()) {
            ...
            Toast.makeText(this@PostActivity, "Please enter an image description.", Toast.LENGTH_SHORT).show()
        }
        else {
            Toast.makeText(this@PostActivity, "Please insert the image file first.", Toast.LENGTH_SHORT).show()
        }
    }
}